    ...
    if (!user) {
      ...
      try {
        ...
        const response = await axios.put(
          ...
          }/user/selected-class?id=${id}&email=${user?.email}`
        );
  ...
  return (
    <div className="card-container my-5 mx-4">
      ...
      <p className="text-center text-white mb-5">
        Enroll in our exciting music classes and embark on a transformable
        journey to discover and explore your passion for music. With our wide
        range of instrument options and highly skilled instructors, you will
        have the opportunity to delve deeper into the world of music like never
        before.
      </p>
      {classLoading && (
        <Spinner
        ...
        {!classLoading &&
          ...
          classes.map((classItem) => (
            <Col key={classItem._id} xs={12} sm={6} md={4} lg={3}>
              <div
                className="card mb-3"
                style={{ backgroundColor: `${classItem.seats == 0 && "red"}` }}
              >
                ...
                <div className="card-body">
                  ...
                  >
                    {isSelected(classItem._id) ? "Selected" : "Select"}
                  </button>
                </div>
              </div>
            </Col>
